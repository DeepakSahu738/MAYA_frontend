...
export default function ContentGenerationYouTube(){
    ...
    const [keywords, setKeywords] = useState([]);
        ...
        const [videoIdeas, setVideoIdeas] = useState([]);
                                ...
                                const [thumbnailAndBrandings, setThumbnailAndBrandings] = useState([]);
        ...
        const handleGenerateResult =  async (e) => {
            ...
            try {
                ...
                setSeoList(response.data.VideoIdeasData.seoList.seoTitles || []);
                setHashtags(response.data.VideoIdeasData.hashtagList.hashtags || []);
                setThumbnailAndBrandings(response.data.VideoIdeasData.thumbnailAndBrandingList.thumbnailAndBrandings || []);
                setEngagements(response.data.VideoIdeasData.engagementList.engagements || []);
                        ...
                        <details className="group border-t border-gray-200" open>
                            <summary className="flex items-center justify-between p-5 cursor-pointer focus:outline-none">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <h3 className="text-lg font-bold">SEO friendly titles to refer</h3>
                                </div>
                                <svg
                                    className="w-5 h-5 text-gray-500 group-open:rotate-180 transition-transform"
                                    fill="none"
                            ...
                            <div className="px-5 pb-5">
                                {seoList.length > 0 ? (
                                    ...
                                    {seoList.map((item, index) => (
                                        ...
                                        <p className="pt-0.5">{item.seotitle}</p>
                                        </li>
                                    ))}
                                    </ul>
                                ) : (
                                    <p className="text-gray-500 text-sm italic">Loading Titles...</p>
                                )}
                                </div>
                        </details>
                        ...
                        <details className="group border-t border-gray-200" open>
                            <summary className="flex items-center justify-between p-5 cursor-pointer focus:outline-none">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <h3 className="text-lg font-bold">Thumbnail And Brandings Ideas</h3>
                                </div>
                                <svg
                                    className="w-5 h-5 text-gray-500 group-open:rotate-180 transition-transform"
                                    fill="none"
                            ...
                            <div className="px-5 pb-5">
                                {thumbnailAndBrandings.length > 0 ? (
                                    <ul className="space-y-4">
                                    {thumbnailAndBrandings.map((item, index) => (
                                        <li key={index} className="flex items-start">
                                        <div className="flex-shrink-0 flex items-center justify-center w-7 h-7 rounded-full bg-teal-600 text-white font-medium text-sm mr-3">
                                            {index + 1}
                                        </div>
                                        <p className="pt-0.5">{item.thumbnailAndBranding}</p>
                                        </li>
                                    ))}
                                    </ul>
                                ) : (
                                    <p className="text-gray-500 text-sm italic">Loading Thumbnail And Branding...</p>
                                )}
                                </div>
                        </details>
                        ...
                        <details className="group border-t border-gray-200" open>
                            <summary className="flex items-center justify-between p-5 cursor-pointer focus:outline-none">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <h3 className="text-lg font-bold">Engagement Tips</h3>
                                </div>
                                <svg
                                    className="w-5 h-5 text-gray-500 group-open:rotate-180 transition-transform"
                                    fill="none"
                            ...
                            <div className="px-5 pb-5">
                                {engagements.length > 0 ? (
                                    ...
                                    <p className="text-gray-500 text-sm italic">Loading Engagement Tips...</p>
                                )}
                                </div>
                        </details>
