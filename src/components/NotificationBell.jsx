...
export default function NotificationBell() {
  ...
  return (
    <div className="relative" ref={wrapperRef}>
      ...
      {isOpen && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl shadow-xl z-30 overflow-hidden">
          {/* Header */}
